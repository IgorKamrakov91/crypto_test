...
describe('validation helpers', () => {
  ...
  it('rejects localhost, private, and reserved RPC hosts', () => {
    ...
    assert.equal(hasValidRpcUrlFormat('http://2130706433:8545'), false)
    assert.equal(hasValidRpcUrlFormat('http://0x7f000001:8545'), false)
    assert.equal(hasValidRpcUrlFormat('http://0177.0000.0000.0001:8545'), false)
    assert.equal(hasValidRpcUrlFormat('http://010.0.0.1:8545'), false)
